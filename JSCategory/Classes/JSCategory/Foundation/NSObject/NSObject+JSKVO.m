...
@interface _JSNSObjectKVOBlockTarget : NSObject
...
@implementation _JSNSObjectKVOBlockTarget
...
- (void)js_addObserverBlockForKeyPath:(NSString *)keyPath block:(void (^)(__weak id obj, id oldVal, id newVal))block {
    if (!keyPath || !block) return;
    _JSNSObjectKVOBlockTarget *target = [[_JSNSObjectKVOBlockTarget alloc] initWithBlock:block];
