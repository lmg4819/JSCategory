...
{
    return [[self dataUsingEncoding:NSUTF8StringEncoding] js_hmacMD5StringWithKey:key];
}

- (NSString *)js_hmacSHA1StringWithKey:(NSString *)key
{
    return [[self dataUsingEncoding:NSUTF8StringEncoding] js_hmacSHA1StringWithKey:key];
}

- (NSString *)js_hmacSHA256StringWithKey:(NSString *)key
{
    return [[self dataUsingEncoding:NSUTF8StringEncoding] js_hmacSHA256StringWithKey:key];
}

- (NSString *)js_hmacSHA512StringWithKey:(NSString *)key
{
    return [[self dataUsingEncoding:NSUTF8StringEncoding] js_hmacSHA512StringWithKey:key];
}
...
- (NSString *)js_base64EncodedString {
    return [[self dataUsingEncoding:NSUTF8StringEncoding] js_base64EncodedString];
}
