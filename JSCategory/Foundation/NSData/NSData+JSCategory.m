...
- (NSString *)js_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)js_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)js_hmacMD5StringWithKey:(NSString *)key {
    return [self js_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)js_hmacMD5DataWithKey:(NSData *)key {
    return [self js_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)js_hmacSHA1StringWithKey:(NSString *)key {
    return [self js_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)js_hmacSHA1DataWithKey:(NSData *)key {
    return [self js_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)js_hmacSHA256StringWithKey:(NSString *)key {
    return [self js_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)js_hmacSHA256DataWithKey:(NSData *)key {
    return [self js_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)js_hmacSHA512StringWithKey:(NSString *)key {
    return [self js_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)js_hmacSHA512DataWithKey:(NSData *)key {
    return [self js_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)js_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)js_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
+ (NSData *)js_dataWithHexString:(NSString *)hexStr {
