...
#  s.source_files = "JSCategory", "JSCategory/*.{h}","JSCategory/**/*.{h,m}"
  ...
  #    foundation.source_files = 'JSCategory/Foundation/**/*.{h,m}'
       ...
       foundation.subspec 'NSArray' do |array|
            array.source_files = 'JSCategory/Foundation/NSArray/*.{h,m}'
       end
  ...
  #UIKit
   ...
   #   quartzcore.source_files = 'JSCategory/Quartz/**/*.{h,m}'
       quartzcore.public_header_files = 'JSCategory/Quartz/Quartz_JS.h'
       quartzcore.source_files = 'JSCategory/Quartz/Quartz_JS.h'
       quartzcore.frameworks = 'QuartzCore','UIKit'

       #三级
       quartzcore.subspec 'CALayer' do |layer|
       layer.source_files = 'JSCategory/Quartz/CALayer/*.{h,m}'
       end
   end
end
